...
export const partyQuizzes: SeedQuiz[] = [
  // ── 16. Мемология 101 — EASY ─────────────────────────────────────────────────
  {
    title: 'Мемология 101',
    description: 'Мемы, которые объединяют поколения. Ну, почти.',
    category: 'PARTY',
    difficulty: 'EASY',
    coverUrl: 'http://localhost:5173/assets/covers/party.svg',
    squareCoverUrl: 'http://localhost:5173/assets/covers/square/party.svg',
    themeColor: '#ffd166',
    ...
    questions: [
      ...
      {
        order: 9,
        questionText: 'В каком году появился первый "Rickroll"?',
        options: ['2005', '2007', '2010', '2012'],
        correctIndex: 1,
        explanation:
          'Первый Rickroll зафиксирован в 2007 на 4chan. "Never Gonna Give You Up" Рика Эстли — вечный мем.',
      },
      {
        order: 10,
  ...
  // ── 18. Детство без подписки — EASY ──────────────────────────────────────────
  {
    ...
    questions: [
      {
        order: 0,
        questionText: 'Как звали черепаху, рыбку и говорящего попугая из мультфильма про пляж?',
        options: [
          'Мася, Рыбка, Кеша',
          'Жора, Немо, Пол',
          'Тортилла, Буль, Кеша',
        ...
        correctIndex: 2,
        explanation:
          '"Простоквашино на море" — нет. Это "Умка", "Как стать большим"... Кеша-попугай — из советского мультфильма.',
      },
      {
        order: 1,
      ...
      {
        order: 3,
        questionText: 'Какой телеканал в России первым запустил круглосуточное детское вещание?',
        options: ['ТВ-3', 'Карусель', '2x2', 'Fox Kids'],
        correctIndex: 1,
        explanation:
          '"Карусель" — первый специализированный детский канал круглосуточного вещания в России.',
      },
      {
        order: 4,
        questionText:
      ...
      },
      {
        order: 7,
        questionText:
          'Как называлась программа на российском ТВ, где дети угадывали песни и отвечали на вопросы ради поездки в "Артек"?',
        options: ['Угадай мелодию', 'Звёздный час', 'Умники и умницы', 'Любопытный Барт'],
        correctIndex: 1,
        explanation:
          '"Звёздный час" — популярная детская викторина 90-х на ОРТ. Вёл Сергей Супонев.',
      },
      {
        order: 8,
  ...
  // ── 19. Нулевые вернулись — MEDIUM ───────────────────────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        order: 3,
        questionText:
          'Как назывался сайт для хостинга музыки, ставший платформой для независимых артистов до SoundCloud?',
        options: ['Last.fm', 'Purevolume', 'Bandcamp', 'Imeem'],
        correctIndex: 1,
        explanation:
          'Purevolume (2003) — первый крупный хостинг для независимой музыки. Умер около 2016.',
      },
      {
        order: 4,
      ...
      {
        order: 5,
        questionText: 'Какой фильм 2001 года стал главным мемом про "одного не оставят дома"?',
        options: ['Гарри Поттер', 'Властелин колец', 'Сонная лощина', 'Один дома 3'],
        correctIndex: 1,
        explanation: '"Хранители кольца" вышли в декабре 2001. Один дома был снят ещё в 1990.',
      },
      {
        order: 6,
